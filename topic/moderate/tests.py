...
class TopicViewTest(TestCase):
    ...
    def test_topic_moderate_delete(self):
        ...
        """
        utils.login(self)
        self.user.jf.is_moderator = True
        self.user.save()

        category = utils.create_category()
        topic = utils.create_topic(category)
        form_data = {}
        response = self.client.post(reverse('topic:moderate:delete', kwargs={'pk': topic.pk, }),
                                    form_data)
    ...
    def test_topic_moderate_undelete(self):
        ...
        form_data = {}
        response = self.client.post(reverse('topic:moderate:undelete', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
    ...
    def test_topic_moderate_lock(self):
        ...
        topic = utils.create_topic(category)
        form_data = {}
        response = self.client.post(reverse('topic:moderate:lock', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
    ...
    def test_topic_moderate_unlock(self):
        ...
        form_data = {}
        response = self.client.post(reverse('topic:moderate:unlock', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
    ...
    def test_topic_moderate_pin(self):
        ...
        topic = utils.create_topic(category)
        form_data = {}
        response = self.client.post(reverse('topic:moderate:pin', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
    ...
    def test_topic_moderate_unpin(self):
        ...
        form_data = {}
        response = self.client.post(reverse('topic:moderate:unpin', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
    ...
    def test_topic_moderate_global_pin(self):
        ...
        topic = utils.create_topic(category)
        form_data = {}
        response = self.client.post(reverse('topic:moderate:global-pin', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
    ...
    def test_topic_moderate_global_unpin(self):
        ...
        form_data = {}
        response = self.client.post(reverse('topic:moderate:global-unpin', kwargs={'pk': topic.pk, }),
                                    form_data)
        expected_url = topic.get_absolute_url()
        self.assertRedirects(response, expected_url, status_code=302)
