...
(function() {
  ...
  Like = (function() {
    ...
    Like.prototype.sendLike = function() {
      ...
      this.isSending = true;
      post = jQuery.post(this.el.attr('href'), {
    ...
    Like.prototype.addLike = function(data) {
      ...
      removeLikeText = jQuery.format(this.options.removeLikeText, {
        count: count
      });
    ...
    Like.prototype.removeLike = function(data) {
      ...
      count -= 1;
      this.el.data('count', count);
      likeText = jQuery.format(this.options.likeText, {
        count: count
      });
    ...
    like: function(options) {
      return this.each(function() {
        if (!jQuery(this).data('plugin_like')) {
          return jQuery(this).data('plugin_like', new Like(this, options));
        }
      });
    }
  });

  jQuery.fn.like.Like = Like;
