...
def index_ajax(request):
    ...
    notifications = TopicNotification.objects\
        ...
        .select_related('comment__user__jf', 'comment__topic')

    notifications = notifications[:settings.NOTIFICATIONS_PER_PAGE]
...
def index_unread(request):
    ...
    return render(request, 'forum/topic/notification/index_unread.html', context)
...
def index(request):
    ...
    return render(request, 'forum/topic/notification/index.html', context)
