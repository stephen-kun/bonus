...
def edit(request, user_id):
    ...
    if request.method == 'POST':
        ...
        form = UserProfileForm(data=request.POST, instance=user.jf)
        ...
        form = UserProfileForm(instance=user.jf)
    ...
    return render(request, 'forum/user/admin/edit.html', context)
...
def index(request):
    return _index(
        ...
        template='forum/user/admin/index.html'
    )
...
def index_admins(request):
    return _index(
        ...
        template='forum/user/admin/admins.html'
    )
...
def index_mods(request):
    return _index(
        ...
        template='forum/user/admin/mods.html'
    )
...
def index_unactive(request):
    return _index(
        ...
        template='forum/user/admin/unactive.html'
    )
