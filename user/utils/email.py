...
def sender(request, subject, template_name, context, to):
    ...
    # todo: remove in JoyForum 0.5 (use DEFAULT_FROM_EMAIL)
...
def send_activation_email(request, user):
    ...
    template_name = 'forum/user/activation_email.html'
...
def send_email_change_email(request, user, new_email):
    ...
    template_name = 'forum/user/email_change_email.html'
...
def send_notification_email(request, topic_notifications, comment):
    ...
    template_name = 'forum/user/notification_email.html'
