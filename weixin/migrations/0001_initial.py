    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own_bonus_detail', models.CharField(default='123456', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.Consumer')),
            ],
        ),
        migrations.CreateModel(
            name='DiningSession',
            fields=[
                ...
                ('snd_bonus', models.TextField(blank=True, max_length=400, null=True)),
                ('rcv_bonus', models.TextField(blank=True, max_length=400, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recharge_person', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recharge_set', to='weixin.Consumer')),
            ],
        ),
        migrations.CreateModel(
            name='RecordRcvBonus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consume_time', models.DateTimeField(blank=True, null=True)),
                ('consumer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ticket_set', to='weixin.Consumer')),
            ],
        ),
        migrations.CreateModel(
            name='VirtualMoney',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_receive', models.BooleanField(default=False)),
                ('consumer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wallet_set', to='weixin.Consumer')),
                ('money', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.VirtualMoney')),
                ('rcv_bonus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.RcvBonus')),
                ('recharge', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='wallet_set', to='weixin.Recharge')),
                ('snd_bonus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.SndBonus')),
                ('ticket', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.Ticket')),
            ],
        ),
        migrations.AddField(
            model_name='rcvbonus',
            name='record_rcv_bonus',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.RecordRcvBonus'),
        ),
        migrations.AddField(
            model_name='rcvbonus',
            name='session',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.DiningSession'),
        ),
        migrations.AddField(
            model_name='rcvbonus',
            name='snd_bonus',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.SndBonus'),
        ),
        migrations.AddField(
            model_name='rcvbonus',
            name='table',
        ...
        migrations.AddField(
            model_name='consumer',
            name='on_table',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='weixin.DiningTable'),
        ),
        migrations.AddField(
            model_name='consumer',
            name='session',
