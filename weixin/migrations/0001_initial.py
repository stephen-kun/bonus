# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-27 07:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dining_time', models.DateTimeField(default=django.utils.timezone.now)),
            ],
        ),
        migrations.CreateModel(
            name='Dining',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus_type', models.CharField(default='\u666e\u901a\u7ea2\u5305', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bonus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.SndBonus')),
                ('consumer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.Consumer')),
                ('money', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.VirtualMoney')),
                ('rcv_bonus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.RcvBonus')),
                ('recharge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.Recharge')),
                ('ticket', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.Ticket')),
            ],
        ),
        migrations.AddField(
            model_name='rcvbonus',
            name='record_rcv_bonus',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='weixin.RecordRcvBonus'),
        ),
        migrations.AddField(
            model_name='rcvbonus',
            name='snd_bonus',
