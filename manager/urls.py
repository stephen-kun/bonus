...
from manager.forms import SliderImageFormView, SliderImageListView
from . import views
...
urlpatterns = [
    ...
    url(r'^basic/check_ticket', views.check_ticket, name='check_ticket'),
    ...
    url(r'^statistics/ticket_consume_record/$', views.ticket_consume_record, name='ticket_consume_record'),

    url(r'^forum/$', views.forum_index, name='forum_index'),
    url(r'^forum/newtopic/$', views.forum_new_topic, name='forum_new_topic'),
    url(r'^forum/topic/(?P<pk>\d+)/$', views.forum_topic_detail, kwargs={'slug': "", }, name='forum_topic_detail'),
    url(r'^forum/topic/$',views.forum_topic_list,name='forum_topic_list'),
    url(r'^forum/topic/delete/$',views.forum_topic_delete,kwargs={'pk': None,},name='forum_topic_delete'),
    url(r'^forum/topic/delete/(?P<pk>\d+)/$',views.forum_topic_delete,name='forum_topic_delete'),
    url(r'^forum/topic/unread/$',views.forum_topic_unread,name='forum_topic_unread'),
    url(r'^forum/sliderman/$',SliderImageListView.as_view(),name='forum_slider_man'),
    url(r'^forum/comment/(?P<topic_id>\d+)/publish/$',views.forum_comment_publish,name='forum_comment_publish'),
